...
<?php
	...
	if(isset($_SESSION['userName'])){
		...
		$book_table_query = "INSERT INTO `booking_table`(`first_name`, `last_name`, `date`, `time`, `phone`, `message`,`user_id`) VALUES (:firstName, :lastName, :date, :time, :phone, :message, :userId)";
	...
	{
		echo "<script>alert('Kindly Login for book a table')</script>";
	}
}
	    		...
	    		<div class="book p-4">
	    			...
	    			<form action="index.php" method="post" class="appointment-form">
	    				...
	    				<div class="d-md-flex">
		            		...
		            		<input data-date-start-date="0d" type="text" class="form-control appointment_date" name="date" placeholder="Date">
	            		</div>
		    				</div>
		    				<div class="form-group ml-md-4">
		    					<div class="input-wrap">
	    				...
	    				<div class="d-md-flex">
	    					<div class="form-group">
		              <textarea id="" cols="30" rows="2" class="form-control" name="message" placeholder="Message"></textarea>
		            </div>
		            <div class="form-group ml-md-4">
		              <input type="submit" value="Booking" name="book" class="btn btn-white py-3 px-4">
		            </div>
	    				</div>
	    			</form>
	    		</div>
